...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($select_cart) > 0){
      $message[] = 'The service has been added to the cart';
   }else{
      mysqli_query($conn, "INSERT INTO `cart`(user_id, name, price, image, quantity) VALUES('$user_id', '$product_name', '$product_price', '$product_image', '$product_quantity')") or die('query failed');
      $message[] = 'The service is added to the cart';
   }
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('  Remove The Service From The Cart  ');">Delete</a></td>
         </tr>
      <?php
      ...
      <tr class="table-bottom">
         ...
         <td><a href="index.php?delete_all" onclick="return confirm('   Delete All Services From The Cart');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Delete All </a></td>
      </tr>
   </tbody>
   </table>
